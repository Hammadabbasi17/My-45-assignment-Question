...
// // ----------------Question 11 -----------------// //
// let arr = [ "Sajjad" , "Naemm" , "Ahmed" , "Ali"];
// console.log(arr[0]);
// console.log(arr[1]);
// console.log(arr[2]);
// console.log(arr[3]);
// // ----------------Question 12 -----------------// //
// let freinds = [ "Sajjad" , "Naemm" , "Ahmed" , "Ali"];
...
// }
// // ----------------Question 14 -----------------// //
// let Freinds = [ "Usman" , "Waris" , "huzaifa" , "yaqoob"];
...
// console.log("i invited to hammad please come for dinner ");
// let replace = Freinds.splice(0 , 1 , "hammad");
// console.log(replace);
// for(let a = 0 ; a<Freinds.length ; a++ ){
...
//     console.log(Freinds[a]);
//  }
// console.log("i have found a bigger table so please i want to invite more people");
// Freinds.unshift("sajjad");
//  Freinds.splice(3 , 0 , "imtiaz");
//  Freinds.push("farhan");
// console.log(Freinds);
// // ---------------- Question 17 -----------------// //
// let Freinds = [ "Usman" , "Waris" , "huzaifa" , "yaqoob"];
...
//     let a = Freinds.pop();
//     console.log(`${a} Sorry you can not invite them to dinner`);
// }
...
// console.log(Freinds);
// // ---------------- Question 18 -----------------// //
let location = [" Saudia Arabia ", " Malasyia ", " Iran ", " London "];
...
export {};
// // ---------------- Question 19 -----------------// //
// console.log(`the number of people  i invited for dinner is ${Freinds.length}`);
// // ---------------- Question 20 -----------------// //
...
// console.log(object);
// // ---------------- Question 22 -----------------// //
//  let array = ["hammad", "sajjad", "naeem"];
//  console.log(array[8]);
//  console.log(array[0]);
// // ---------------- Question 23 -----------------// //
//  let car = "honda";
//  // test 1
//  console.log('car === "Honda". this statement i predict true.');
//  console.log(car === "honda");
//  // test 2
//  console.log('car.includes("h"). this statement i predict true.');
//  console.log(car.includes("h"));
//  //test 3
//  console.log('car.toLowerCase() === "honda". this statement i predict true.');
//  console.log(car.toLowerCase() === "honda");
//  // test 4
//  console.log('car.length > 0. this statement i predict true.');
//  console.log(car.length >0);
//  // test 5
//  console.log('car.length === 5. this statement i predict true.')
// console.log(car.length === 5);
// //false statement
// console.log('car === "Alto". this statement i predict False.');
//  console.log(car === "Alto");
//  // test 2
//  console.log('car.includes("f"). this statement i predict false.');
//  console.log(car.includes("f"));
//  //test 3
//  console.log('car.toUppercase() === "honda". this statement i predict False.');
...
// console.log(arr.includes("city")  === true); // True
// console.log(arr.includes("ali")  === true);  // False
// // ---------------- Question 25-----------------// //
...
// }
// // ---------------- Question 30 -----------------// //
// let helloadmin = ["Hammad admin","Ali", "Sarfaraz","zeeshan","Bilal"];
// for(let i =0 ; i<helloadmin.length ; i++){
//     if(helloadmin.includes("Hammad admin")){
//         console.log("Hello admin, Would you like to see a status report");
//        break 
//     }else {
//         console.log(`Hellow ${helloadmin[i]} thank you for logging in again`);
//     }
//}
// let helloadmin = ["sajjad","Ali", "Sarfaraz","zeeshan","Bilal"];
// for(let i =0 ; i<helloadmin.length ; i++){
//     if(helloadmin.includes("Hammad")){
//         console.log("Hello admin, Would you like to see a status report");
//        break 
//     }else {
//         console.log(`Hellow ${helloadmin[i]} thank you for logging in again`);
...
// }
// // ---------------- Question 31 -----------------//
// let N_user = ["Hammad admin","Ali", "Sarfaraz","zeeshan","Bilal"];
// if(N_user.length === 0){
...
// }
// // ---------------- Question 32 -----------------//
// let current_users :string[] = ["Naeem", "Ahmed" , "Mursalin", "farhan", "fahad"];
// let new_user : string[] = ["Naeem", "Ahmed" , "usman", "sajjad", "ali"];
...
// if(c){
//     console.log(`is user ${new_user} is not available`);
// }else{
//     console.log(`is user ${new_user} is available`);
// }
// })
// // ---------------- Question 33 -----------------//
...
//  }
// make_shirt("large", "'NEW YORK CITY'");
// // ---------------- Question 37 -----------------// //
// const make_shirt =( message : string ,size : string = " large" ) =>{
//    return size + message;
//     }
//   let a = make_shirt(" i love typescript" , );
// console.log(a);
...
//    return message + size;
//     }
//   let a = make_shirt(" i love typescript" , " any size"  );
// console.log(a);
// // ---------------- Question 38 -----------------// //
...
// console.log(b);
// let c = city_country( "george town" ,"Malaysia");
// console.log(c);
// // // ---------------- Question 40 -----------------// //
// function myalbum(artistname: string, albumtitle : string){
//     return {artistname , albumtitle};
// }
// let album1 = myalbum("Beyonce","Lemonade");
// let album2 = myalbum("Fleetwood mac","Rumours");
...
// }
// let album1 = myalbum("Beyonce","Lemonade", 10);
// let album2 = myalbum("Fleetwood mac","Rumours",40);
// let album3 = myalbum("Nirvana","Nevermind");
// console.log(album1);
// console.log(album2);
// console.log(album3);
// // // ---------------- Question 41 -----------------// //
// let a : string[] = ["Hammad" ,"sajjad","ali" ];
...
// }
// let any = mysandwiches("Bacon" ,"Mayo","turkey");
// let any1 = mysandwiches("chicken sandwich" , "Ham");
// let any2 = mysandwiches();
// console.log(any);
// console.log(any1);
// console.log(any2);
// // // ---------------- Question 45 -----------------// //
// function car_details ( manufacturer: string, modelname : string, ... addinfo: any[]){
// const car = {manufacturer, modelname, ...Object.fromEntries(addinfo)};
// return car
// }
// const my_car = car_details("Toyota","corolla",["colour","black"],[ "year", "2022"]);
// console.log(my_car);
